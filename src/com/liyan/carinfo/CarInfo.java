 ...
 * 例：appid(com.example.demo) 则加载类 com.example.CarInfo<br>
 ...
 * 具体功能可以查看文档
 */
public class CarInfo extends JcqAppAbstract implements ICQVer, IMsg, IRequest {
    ...
    public static void main(String[] args) {
        ...
        CQ.logInfo("[JCQ] TEST CarInfo", "测试启动");// 现在就可以用CQ变量来执行任何想要的操作了
        // 要测试主类就先实例化一个主类对象
        CarInfo demo = new CarInfo();
...
//        demo.groupMsg(0, 10008, 3456789012L, 11111111114L, "", "小喵呢，出来玩玩呀", 0);
        demo.groupMsg(0, 10009, 427984429L, 3333333334L, "", "车找人\n" +
                "     今天上午10:30北京回易县。13661204827  （微信同号）\n" +
                " 易县⇔北京拼车，高速车队每天往返，每天早4:30---下午4:00，易县去北京。早6:30-晚7:30北京回易县，随时有车。全新七 座商务，可提供包车 ，捎货，拼车服务！各大医院，机场， 议价可接送，请您提前预订，13661204827  （微信同号）", 0);
...
//        demo.groupMsg(0, 10011, 427984429L, 11111111114L, "", "qwq 有没有一起开的\n[CQ:at,qq=3333333334]你玩嘛", 0);
    ...
    public String appInfo() {
        ...
        String AppID = "com.liyan.carinfo";// 记住编译后的文件和json也要使用appid做文件名
        /**
    ...
    public int startup() {
        ...
        CarParse.Companion.getInstance().start(CQ);
     ...
     */
    public int exit() {
        CarParse.Companion.getInstance().stop();
        return 0;
    }
...
//        long qqId = CC.getAt(msg);// 此方法为简便方法，获取第一个CQ:at里的QQ号，错误时为：-1000
        ...
        CarParse.Companion.getInstance().parse(fromQQ+"",fromGroup+"",msg);
        // 这里处理消息
